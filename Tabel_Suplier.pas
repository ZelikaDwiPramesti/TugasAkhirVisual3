...
if (zqry1.Locate('nm_suplier',e2.Text,[])) and (zqry1.Locate('alamat',e3.Text,[])) then
begin
...
//simpan
zqry1.SQL.Clear;
zqry1.SQL.Add('insert into suplier values (null,"'+e2.Text+'","'+e3.Text+'","'+e4.Text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update suplier set nm_suplier= "'+e2.Text+'",alamat="'+e3.Text+'",no_telp="'+e4.Text+'" where id="'+id+'"');
zqry1. ExecSQL;
...
procedure TForm13.dg1CellClick(Column: TColumn);
begin
enable;
b1.Enabled:= False;
b2.Enabled:= False;
